...
void as608_output_result_message(uint8_t result)
{
    ...
    case 0x18:
        ...
        break;
    case 0xF0:
        printf("有后续数据包的指令，正确接收后用 0xf0 应答\r\n");
        break;
    case 0xF1:
        printf("有后续数据包的指令，命令包用 0xf1 应答\r\n");
        break;
    case 0xF2:
        printf("烧写内部 FLASH 时，校验和错误\r\n");
        break;
    case 0xF3:
        printf("烧写内部 FLASH 时，包标识错误\r\n");
        break;
    case 0xF4:
        printf("烧写内部 FLASH 时，包长度错误\r\n");
        break;
    case 0xF5:
        printf("烧写内部 FLASH 时，代码长度太长\r\n");
        break;
    case 0xF6:
        printf("烧写内部 FLASH 时，烧写 FLASH 失败\r\n");
        break;
    case 0x19:
        printf("未定义错误\r\n");
        break;
