        ...
        if ((tfont16[k].Index[0]==*(s))&&(tfont16[k].Index[1]==*(s+1)))
        {
            ...
            for(i=0;i<TypefaceNum;i++)
            {
                for(j=0;j<8;j++)
                {
                        ...
                        if(tfont16[k].Msk[i]&(0x01<<j)) lcd_draw_point_color(x,y,fc);//画一个点
                        x++;
                        if((x-x0)==sizey)
                        {
                            x=x0;
        ...
        if ((tfont24[k].Index[0]==*(s))&&(tfont24[k].Index[1]==*(s+1)))
        {
            ...
            for(i=0;i<TypefaceNum;i++)
            {
                for(j=0;j<8;j++)
                {
                        ...
                        if(tfont24[k].Msk[i]&(0x01<<j)) lcd_draw_point_color(x,y,fc);//画一个点
                        x++;
                        if((x-x0)==sizey)
                        {
                            x=x0;
        ...
        if ((tfont32[k].Index[0]==*(s))&&(tfont32[k].Index[1]==*(s+1)))
        {
            ...
            for(i=0;i<TypefaceNum;i++)
            {
                for(j=0;j<8;j++)
                {
                        ...
                        if(tfont32[k].Msk[i]&(0x01<<j)) lcd_draw_point_color(x,y,fc);//画一个点
                        x++;
                        if((x-x0)==sizey)
                        {
                            x=x0;
...
void LCD_ShowChinese(u16 x,u16 y,u8 *s,u16 fc,u16 bc,u8 sizey)
{
    while(*s!=0)
    {
        if(sizey==16) LCD_ShowChinese16x16(x,y,s,fc,bc,sizey);
