...
void ui_userScreen_screen_init(void)
{
    ...
    lv_obj_set_style_outline_color(ui_enterpassword, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_opa(ui_enterpassword, 255, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_outline_color(ui_camera, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_opa(ui_camera, 255, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
